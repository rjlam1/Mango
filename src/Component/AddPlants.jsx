      ...
      <form onSubmit={handleAddPlant} className="space-y-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          {[
            ...
            <fieldset key={name} className="p-4 border border-gray-300 shadow-sm rounded-xl bg-base-100">
          ...
          {/* Category */}
          <fieldset className="p-4 border border-gray-300 shadow-sm rounded-xl bg-base-100">
          ...
          {/* Care Level */}
          <fieldset className="p-4 border border-gray-300 shadow-sm rounded-xl bg-base-100">
            <label className="block mb-2 font-medium text-gray-700">Care Level</label>
            <select name="careLevel" className="w-full select select-bordered" required>
              <option value="">Pick one</option>
