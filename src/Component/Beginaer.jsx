...
const BeginnerFriendlyPlants = () => {
  ...
  return (
    <section className={`px-4 py-5 ${isDark ? "bg-gray-900 text-white" : "bg-white text-gray-800"}`}>
      <div className="mx-auto text-center">
        <h2 className="mb-4 text-3xl font-bold text-green-800">Beginner-Friendly Plants</h2>
