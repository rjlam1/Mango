...
//       { path: "/plant/:id", element: <PrivateRoute><ViewDetails /></PrivateRoute>, loader: ({ params }) => fetch(`http://localhost:5000/plants/${params.id}`) },
//       { path: "/update/:id", element: <PrivateRoute><UpdatePlant /></PrivateRoute>, loader: ({ params }) => fetch(`http://localhost:5000/plants/${params.id}`) }
//     ]
//   },
// ]);
