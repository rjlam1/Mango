...
//       { path: "/plant/:id", element: <PrivateRoute><ViewDetails /></PrivateRoute>, loader: ({ params }) => fetch(`https://mongo-p44biutha-rjlam1s-projects.vercel.app/plants/${params.id}`) },
//       { path: "/update/:id", element: <PrivateRoute><UpdatePlant /></PrivateRoute>, loader: ({ params }) => fetch(`https://mongo-p44biutha-rjlam1s-projects.vercel.app/plants/${params.id}`) }
//     ]
//   },
// ]);
...
const Router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) => fetch(`https://mongo-p44biutha-rjlam1s-projects.vercel.app/mango/${params.id}`)
      },
      {
        path: '/update/:id',
        element: (
